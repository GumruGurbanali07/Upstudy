...
namespace CourseApp.Migrations
{
    ...
    [Migration("20240529194137_mig_Update_TeacherTable_Description")]
    partial class mig_Update_TeacherTable_Description
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseApp.Models.Blog", b =>
                {
            ...
            modelBuilder.Entity("CourseApp.Models.BlogCategory", b =>
                {
                    b.Property<int>("BlogCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CourseApp.Models.Graduate", b =>
                {
            ...
            modelBuilder.Entity("CourseApp.Models.TeacherSocial", b =>
                {
            ...
            modelBuilder.Entity("CourseApp.Models.Blog", b =>
                {
                    b.HasOne("CourseApp.Models.BlogCategory", "BlogCategory")
                        .WithMany()
                        .HasForeignKey("BlogCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CourseApp.Models.Teacher", "Teacher")
                        .WithMany("Blogs")
